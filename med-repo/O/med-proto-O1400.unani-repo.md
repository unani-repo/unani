O140,0,O1400,"Mild to moderate pre-eclampsia, unspecified trimester", "Mild to moderate pre-eclampsia, unspecified trimester","Mild to moderate pre-eclampsia"
# Category title: Mild to moderate pre-eclampsia

Abbreviated description: Mild to moderate pre-eclampsia, unspecified trimester

Full description: Mild to moderate pre-eclampsia, unspecified trimester
