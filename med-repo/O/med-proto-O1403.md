O140,3,O1403,"Mild to moderate pre-eclampsia, third trimester", "Mild to moderate pre-eclampsia, third trimester","Mild to moderate pre-eclampsia"
# Category title: Mild to moderate pre-eclampsia

Abbreviated description: Mild to moderate pre-eclampsia, third trimester

Full description: Mild to moderate pre-eclampsia, third trimester
