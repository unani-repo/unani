O140,2,O1402,"Mild to moderate pre-eclampsia, second trimester", "Mild to moderate pre-eclampsia, second trimester","Mild to moderate pre-eclampsia"
# Category title: Mild to moderate pre-eclampsia

Abbreviated description: Mild to moderate pre-eclampsia, second trimester

Full description: Mild to moderate pre-eclampsia, second trimester
