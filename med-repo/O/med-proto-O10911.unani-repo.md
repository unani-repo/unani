O1091,1,O10911,"Unsp pre-existing htn comp pregnancy, first trimester", "Unspecified pre-existing hypertension complicating pregnancy, first trimester","Unspecified pre-existing hypertension complicating pregnancy"
# Category title: Unspecified pre-existing hypertension complicating pregnancy

Abbreviated description: Unsp pre-existing htn comp pregnancy, first trimester

Full description: Unspecified pre-existing hypertension complicating pregnancy, first trimester
