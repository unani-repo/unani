O11,1,O111,"Pre-existing hypertension w pre-eclampsia, first trimester", "Pre-existing hypertension with pre-eclampsia, first trimester","Pre-existing hypertension with pre-eclampsia"
# Category title: Pre-existing hypertension with pre-eclampsia

Abbreviated description: Pre-existing hypertension w pre-eclampsia, first trimester

Full description: Pre-existing hypertension with pre-eclampsia, first trimester
