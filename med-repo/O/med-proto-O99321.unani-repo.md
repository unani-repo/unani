O9932,1,O99321,"Drug use complicating pregnancy, first trimester", "Drug use complicating pregnancy, first trimester","Drug use complicating pregnancy, childbirth, and the puerperium"
# Category title: Drug use complicating pregnancy, childbirth, and the puerperium

Abbreviated description: Drug use complicating pregnancy, first trimester

Full description: Drug use complicating pregnancy, first trimester
