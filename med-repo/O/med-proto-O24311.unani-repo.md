O2431,1,O24311,"Unsp pre-existing diabetes in pregnancy, first trimester", "Unspecified pre-existing diabetes mellitus in pregnancy, first trimester","Unspecified pre-existing diabetes mellitus in pregnancy"
# Category title: Unspecified pre-existing diabetes mellitus in pregnancy

Abbreviated description: Unsp pre-existing diabetes in pregnancy, first trimester

Full description: Unspecified pre-existing diabetes mellitus in pregnancy, first trimester
