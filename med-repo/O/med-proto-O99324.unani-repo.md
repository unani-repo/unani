O9932,4,O99324,"Drug use complicating childbirth", "Drug use complicating childbirth","Drug use complicating pregnancy, childbirth, and the puerperium"
# Category title: Drug use complicating pregnancy, childbirth, and the puerperium

Abbreviated description: Drug use complicating childbirth

Full description: Drug use complicating childbirth
