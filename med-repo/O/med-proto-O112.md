O11,2,O112,"Pre-existing hypertension w pre-eclampsia, second trimester", "Pre-existing hypertension with pre-eclampsia, second trimester","Pre-existing hypertension with pre-eclampsia"
# Category title: Pre-existing hypertension with pre-eclampsia

Abbreviated description: Pre-existing hypertension w pre-eclampsia, second trimester

Full description: Pre-existing hypertension with pre-eclampsia, second trimester
