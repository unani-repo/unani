F1692,0,F16920,"Hallucinogen use, unsp with intoxication, uncomplicated", "Hallucinogen use, unspecified with intoxication, uncomplicated","Hallucinogen use, unspecified with intoxication"
# Category title: Hallucinogen use, unspecified with intoxication

Abbreviated description: Hallucinogen use, unsp with intoxication, uncomplicated

Full description: Hallucinogen use, unspecified with intoxication, uncomplicated
