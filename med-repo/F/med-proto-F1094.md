F1092,F1094,F1094,"Alcohol use, unspecified with alcohol-induced mood disorder", "Alcohol use, unspecified with alcohol-induced mood disorder","Alcohol use, unspecified with intoxication"
# Category title: Alcohol use, unspecified with intoxication

Abbreviated description: Alcohol use, unspecified with alcohol-induced mood disorder

Full description: Alcohol use, unspecified with alcohol-induced mood disorder
