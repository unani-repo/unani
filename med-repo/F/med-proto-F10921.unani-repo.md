F1092,1,F10921,"Alcohol use, unspecified with intoxication delirium", "Alcohol use, unspecified with intoxication delirium","Alcohol use, unspecified with intoxication"
# Category title: Alcohol use, unspecified with intoxication

Abbreviated description: Alcohol use, unspecified with intoxication delirium

Full description: Alcohol use, unspecified with intoxication delirium
