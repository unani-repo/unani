F1098,F1099,F1099,"Alcohol use, unsp with unspecified alcohol-induced disorder", "Alcohol use, unspecified with unspecified alcohol-induced disorder","Alcohol use, unspecified with other alcohol-induced disorders"
# Category title: Alcohol use, unspecified with other alcohol-induced disorders

Abbreviated description: Alcohol use, unsp with unspecified alcohol-induced disorder

Full description: Alcohol use, unspecified with unspecified alcohol-induced disorder
