F1098,0,F10980,"Alcohol use, unsp with alcohol-induced anxiety disorder", "Alcohol use, unspecified with alcohol-induced anxiety disorder","Alcohol use, unspecified with other alcohol-induced disorders"
# Category title: Alcohol use, unspecified with other alcohol-induced disorders

Abbreviated description: Alcohol use, unsp with alcohol-induced anxiety disorder

Full description: Alcohol use, unspecified with alcohol-induced anxiety disorder
