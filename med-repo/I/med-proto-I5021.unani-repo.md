I502,1,I5021,"Acute systolic (congestive) heart failure", "Acute systolic (congestive) heart failure","Systolic (congestive) heart failure"
# Category title: Systolic (congestive) heart failure

Abbreviated description: Acute systolic (congestive) heart failure

Full description: Acute systolic (congestive) heart failure
