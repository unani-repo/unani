M2173,3,M21733,"Unequal limb length (acquired), right radius", "Unequal limb length (acquired), right radius","Unequal limb length (acquired), ulna and radius"
# Category title: Unequal limb length (acquired), ulna and radius

Abbreviated description: Unequal limb length (acquired), right radius

Full description: Unequal limb length (acquired), right radius
