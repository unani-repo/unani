T48902,A,T48902A,"Poisn by unsp agents prim act on the resp sys, slf-hrm, init", "Poisoning by unspecified agents primarily acting on the respiratory system, intentional self-harm, initial encounter","Poisoning by unspecified agents primarily acting on the respiratory system, intentional self-harm"
# Category title: Poisoning by unspecified agents primarily acting on the respiratory system, intentional self-harm

Abbreviated description: Poisn by unsp agents prim act on the resp sys, slf-hrm, init

Full description: Poisoning by unspecified agents primarily acting on the respiratory system, intentional self-harm, initial encounter
