T420X2,A,T420X2A,"Poisoning by hydantoin derivatives, self-harm, init", "Poisoning by hydantoin derivatives, intentional self-harm, initial encounter","Poisoning by hydantoin derivatives, intentional self-harm"
# Category title: Poisoning by hydantoin derivatives, intentional self-harm

Abbreviated description: Poisoning by hydantoin derivatives, self-harm, init

Full description: Poisoning by hydantoin derivatives, intentional self-harm, initial encounter
