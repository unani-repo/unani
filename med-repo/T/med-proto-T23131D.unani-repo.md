T23131,D,T23131D,"Burn first deg mult right fngr (nail), not inc thumb, subs", "Burn of first degree of multiple right fingers (nail), not including thumb, subsequent encounter","Burn of first degree of multiple right fingers (nail), not including thumb"
# Category title: Burn of first degree of multiple right fingers (nail), not including thumb

Abbreviated description: Burn first deg mult right fngr (nail), not inc thumb, subs

Full description: Burn of first degree of multiple right fingers (nail), not including thumb, subsequent encounter
