T82513,A,T82513A,"Breakdown of balloon (counterpulsation) device, init", "Breakdown (mechanical) of balloon (counterpulsation) device, initial encounter","Breakdown (mechanical) of balloon (counterpulsation) device"
# Category title: Breakdown (mechanical) of balloon (counterpulsation) device

Abbreviated description: Breakdown of balloon (counterpulsation) device, init

Full description: Breakdown (mechanical) of balloon (counterpulsation) device, initial encounter
