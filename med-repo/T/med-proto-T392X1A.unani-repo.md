T392X1,A,T392X1A,"Poisoning by pyrazolone derivatives, accidental, init", "Poisoning by pyrazolone derivatives, accidental (unintentional), initial encounter","Poisoning by pyrazolone derivatives, accidental (unintentional)"
# Category title: Poisoning by pyrazolone derivatives, accidental (unintentional)

Abbreviated description: Poisoning by pyrazolone derivatives, accidental, init

Full description: Poisoning by pyrazolone derivatives, accidental (unintentional), initial encounter
