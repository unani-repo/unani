T461X1,A,T461X1A,"Poisoning by calcium-channel blockers, accidental, init", "Poisoning by calcium-channel blockers, accidental (unintentional), initial encounter","Poisoning by calcium-channel blockers, accidental (unintentional)"
# Category title: Poisoning by calcium-channel blockers, accidental (unintentional)

Abbreviated description: Poisoning by calcium-channel blockers, accidental, init

Full description: Poisoning by calcium-channel blockers, accidental (unintentional), initial encounter
