T48991,D,T48991D,"Poisn by oth agents prim acting on the resp sys, acc, subs", "Poisoning by other agents primarily acting on the respiratory system, accidental (unintentional), subsequent encounter","Poisoning by other agents primarily acting on the respiratory system, accidental (unintentional)"
# Category title: Poisoning by other agents primarily acting on the respiratory system, accidental (unintentional)

Abbreviated description: Poisn by oth agents prim acting on the resp sys, acc, subs

Full description: Poisoning by other agents primarily acting on the respiratory system, accidental (unintentional), subsequent encounter
