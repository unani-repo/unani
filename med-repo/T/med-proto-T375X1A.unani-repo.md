T375X1,A,T375X1A,"Poisoning by antiviral drugs, accidental, init", "Poisoning by antiviral drugs, accidental (unintentional), initial encounter","Poisoning by antiviral drugs, accidental (unintentional)"
# Category title: Poisoning by antiviral drugs, accidental (unintentional)

Abbreviated description: Poisoning by antiviral drugs, accidental, init

Full description: Poisoning by antiviral drugs, accidental (unintentional), initial encounter
