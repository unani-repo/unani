T431X2,A,T431X2A,"Poisoning by MAO inhib antidepressants, self-harm, init", "Poisoning by monoamine-oxidase-inhibitor antidepressants, intentional self-harm, initial encounter","Poisoning by monoamine-oxidase-inhibitor antidepressants, intentional self-harm"
# Category title: Poisoning by monoamine-oxidase-inhibitor antidepressants, intentional self-harm

Abbreviated description: Poisoning by MAO inhib antidepressants, self-harm, init

Full description: Poisoning by monoamine-oxidase-inhibitor antidepressants, intentional self-harm, initial encounter
