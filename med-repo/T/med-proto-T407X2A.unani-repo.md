T407X2,A,T407X2A,"Poisoning by cannabis (derivatives), self-harm, init", "Poisoning by cannabis (derivatives), intentional self-harm, initial encounter","Poisoning by cannabis (derivatives), intentional self-harm"
# Category title: Poisoning by cannabis (derivatives), intentional self-harm

Abbreviated description: Poisoning by cannabis (derivatives), self-harm, init

Full description: Poisoning by cannabis (derivatives), intentional self-harm, initial encounter
