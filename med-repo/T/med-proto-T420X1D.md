T420X1,D,T420X1D,"Poisoning by hydantoin derivatives, accidental, subs", "Poisoning by hydantoin derivatives, accidental (unintentional), subsequent encounter","Poisoning by hydantoin derivatives, accidental (unintentional)"
# Category title: Poisoning by hydantoin derivatives, accidental (unintentional)

Abbreviated description: Poisoning by hydantoin derivatives, accidental, subs

Full description: Poisoning by hydantoin derivatives, accidental (unintentional), subsequent encounter
