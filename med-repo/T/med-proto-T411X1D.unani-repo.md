T411X1,D,T411X1D,"Poisoning by intravenous anesthetics, accidental, subs", "Poisoning by intravenous anesthetics, accidental (unintentional), subsequent encounter","Poisoning by intravenous anesthetics, accidental (unintentional)"
# Category title: Poisoning by intravenous anesthetics, accidental (unintentional)

Abbreviated description: Poisoning by intravenous anesthetics, accidental, subs

Full description: Poisoning by intravenous anesthetics, accidental (unintentional), subsequent encounter
