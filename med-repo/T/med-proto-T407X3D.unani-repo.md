T407X3,D,T407X3D,"Poisoning by cannabis (derivatives), assault, subs encntr", "Poisoning by cannabis (derivatives), assault, subsequent encounter","Poisoning by cannabis (derivatives), assault"
# Category title: Poisoning by cannabis (derivatives), assault

Abbreviated description: Poisoning by cannabis (derivatives), assault, subs encntr

Full description: Poisoning by cannabis (derivatives), assault, subsequent encounter
