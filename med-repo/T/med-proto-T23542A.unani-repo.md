T23542,A,T23542A,"Corros first deg mult left fingers (nail), inc thumb, init", "Corrosion of first degree of multiple left fingers (nail), including thumb, initial encounter","Corrosion of first degree of multiple left fingers (nail), including thumb"
# Category title: Corrosion of first degree of multiple left fingers (nail), including thumb

Abbreviated description: Corros first deg mult left fingers (nail), inc thumb, init

Full description: Corrosion of first degree of multiple left fingers (nail), including thumb, initial encounter
