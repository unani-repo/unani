T85810,A,T85810A,"Embolism due to nervous system prosth dev/grft, init", "Embolism due to nervous system prosthetic devices, implants and grafts, initial encounter","Embolism due to nervous system prosthetic devices, implants and grafts"
# Category title: Embolism due to nervous system prosthetic devices, implants and grafts

Abbreviated description: Embolism due to nervous system prosth dev/grft, init

Full description: Embolism due to nervous system prosthetic devices, implants and grafts, initial encounter
