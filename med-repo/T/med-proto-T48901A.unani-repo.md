T48901,A,T48901A,"Poisn by unsp agents prim acting on the resp sys, acc, init", "Poisoning by unspecified agents primarily acting on the respiratory system, accidental (unintentional), initial encounter","Poisoning by unspecified agents primarily acting on the respiratory system, accidental (unintentional)"
# Category title: Poisoning by unspecified agents primarily acting on the respiratory system, accidental (unintentional)

Abbreviated description: Poisn by unsp agents prim acting on the resp sys, acc, init

Full description: Poisoning by unspecified agents primarily acting on the respiratory system, accidental (unintentional), initial encounter
