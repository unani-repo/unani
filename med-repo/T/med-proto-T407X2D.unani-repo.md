T407X2,D,T407X2D,"Poisoning by cannabis (derivatives), self-harm, subs", "Poisoning by cannabis (derivatives), intentional self-harm, subsequent encounter","Poisoning by cannabis (derivatives), intentional self-harm"
# Category title: Poisoning by cannabis (derivatives), intentional self-harm

Abbreviated description: Poisoning by cannabis (derivatives), self-harm, subs

Full description: Poisoning by cannabis (derivatives), intentional self-harm, subsequent encounter
