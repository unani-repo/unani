T46992,D,T46992D,"Poisn by oth agents aff the cardiovasc sys, self-harm, subs", "Poisoning by other agents primarily affecting the cardiovascular system, intentional self-harm, subsequent encounter","Poisoning by other agents primarily affecting the cardiovascular system, intentional self-harm"
# Category title: Poisoning by other agents primarily affecting the cardiovascular system, intentional self-harm

Abbreviated description: Poisn by oth agents aff the cardiovasc sys, self-harm, subs

Full description: Poisoning by other agents primarily affecting the cardiovascular system, intentional self-harm, subsequent encounter
