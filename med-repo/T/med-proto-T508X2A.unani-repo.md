T508X2,A,T508X2A,"Poisoning by diagnostic agents, intentional self-harm, init", "Poisoning by diagnostic agents, intentional self-harm, initial encounter","Poisoning by diagnostic agents, intentional self-harm"
# Category title: Poisoning by diagnostic agents, intentional self-harm

Abbreviated description: Poisoning by diagnostic agents, intentional self-harm, init

Full description: Poisoning by diagnostic agents, intentional self-harm, initial encounter
