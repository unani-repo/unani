V2988,XA,V2988XA,"Mtrcy rider (driver) injured in oth transport acc, init", "Motorcycle rider (driver) (passenger) injured in other specified transport accidents, initial encounter","Motorcycle rider (driver) (passenger) injured in other specified transport accidents"
# Category title: Motorcycle rider (driver) (passenger) injured in other specified transport accidents

Abbreviated description: Mtrcy rider (driver) injured in oth transport acc, init

Full description: Motorcycle rider (driver) (passenger) injured in other specified transport accidents, initial encounter
