V883,XXD,V883XXD,"Person injured in collision betw car and bus, nontraf, subs", "Person injured in collision between car and bus, nontraffic, subsequent encounter","Person injured in collision between car and bus, nontraffic"
# Category title: Person injured in collision between car and bus, nontraffic

Abbreviated description: Person injured in collision betw car and bus, nontraf, subs

Full description: Person injured in collision between car and bus, nontraffic, subsequent encounter
