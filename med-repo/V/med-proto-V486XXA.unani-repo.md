V486,XXA,V486XXA,"Car pasngr injured in nonclsn trnsp accident in traf, init", "Car passenger injured in noncollision transport accident in traffic accident, initial encounter","Car passenger injured in noncollision transport accident in traffic accident"
# Category title: Car passenger injured in noncollision transport accident in traffic accident

Abbreviated description: Car pasngr injured in nonclsn trnsp accident in traf, init

Full description: Car passenger injured in noncollision transport accident in traffic accident, initial encounter
