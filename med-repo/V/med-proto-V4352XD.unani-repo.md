V4352,XD,V4352XD,"Car driver injured in collision w car in traf, subs", "Car driver injured in collision with other type car in traffic accident, subsequent encounter","Car driver injured in collision with other type car in traffic accident"
# Category title: Car driver injured in collision with other type car in traffic accident

Abbreviated description: Car driver injured in collision w car in traf, subs

Full description: Car driver injured in collision with other type car in traffic accident, subsequent encounter
