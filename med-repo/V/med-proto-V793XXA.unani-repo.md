V793,XXA,V793XXA,"Bus occupant (driver) injured in unsp nontraf, init", "Bus occupant (driver) (passenger) injured in unspecified nontraffic accident, initial encounter","Bus occupant (driver) (passenger) injured in unspecified nontraffic accident"
# Category title: Bus occupant (driver) (passenger) injured in unspecified nontraffic accident

Abbreviated description: Bus occupant (driver) injured in unsp nontraf, init

Full description: Bus occupant (driver) (passenger) injured in unspecified nontraffic accident, initial encounter
