V1988,XS,V1988XS,"Pedl cyclst (driver) injured in oth transport acc, sequela", "Pedal cyclist (driver) (passenger) injured in other specified transport accidents, sequela","Pedal cyclist (driver) (passenger) injured in other specified transport accidents"
# Category title: Pedal cyclist (driver) (passenger) injured in other specified transport accidents

Abbreviated description: Pedl cyclst (driver) injured in oth transport acc, sequela

Full description: Pedal cyclist (driver) (passenger) injured in other specified transport accidents, sequela
