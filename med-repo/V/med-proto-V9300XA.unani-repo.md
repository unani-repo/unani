V9300,XA,V9300XA,"Burn due to localized fire on board merchant vessel, init", "Burn due to localized fire on board merchant vessel, initial encounter","Burn due to localized fire on board merchant vessel"
# Category title: Burn due to localized fire on board merchant vessel

Abbreviated description: Burn due to localized fire on board merchant vessel, init

Full description: Burn due to localized fire on board merchant vessel, initial encounter
