V873,XXD,V873XXD,"Person injured in collision betw car and bus (traffic), subs", "Person injured in collision between car and bus (traffic), subsequent encounter","Person injured in collision between car and bus (traffic)"
# Category title: Person injured in collision between car and bus (traffic)

Abbreviated description: Person injured in collision betw car and bus (traffic), subs

Full description: Person injured in collision between car and bus (traffic), subsequent encounter
