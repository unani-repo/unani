V485,XXA,V485XXA,"Car driver injured in nonclsn trnsp accident in traf, init", "Car driver injured in noncollision transport accident in traffic accident, initial encounter","Car driver injured in noncollision transport accident in traffic accident"
# Category title: Car driver injured in noncollision transport accident in traffic accident

Abbreviated description: Car driver injured in nonclsn trnsp accident in traf, init

Full description: Car driver injured in noncollision transport accident in traffic accident, initial encounter
