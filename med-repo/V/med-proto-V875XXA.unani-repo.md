V875,XXA,V875XXA,"Person injured in collision betw hv veh and bus, init", "Person injured in collision between heavy transport vehicle and bus (traffic), initial encounter","Person injured in collision between heavy transport vehicle and bus (traffic)"
# Category title: Person injured in collision between heavy transport vehicle and bus (traffic)

Abbreviated description: Person injured in collision betw hv veh and bus, init

Full description: Person injured in collision between heavy transport vehicle and bus (traffic), initial encounter
