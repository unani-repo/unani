V9301,XA,V9301XA,"Burn due to localized fire on board passenger vessel, init", "Burn due to localized fire on board passenger vessel, initial encounter","Burn due to localized fire on board passenger vessel"
# Category title: Burn due to localized fire on board passenger vessel

Abbreviated description: Burn due to localized fire on board passenger vessel, init

Full description: Burn due to localized fire on board passenger vessel, initial encounter
