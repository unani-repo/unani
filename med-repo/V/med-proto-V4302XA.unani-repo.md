V4302,XA,V4302XA,"Car driver injured in collision w car nontraf, init", "Car driver injured in collision with other type car in nontraffic accident, initial encounter","Car driver injured in collision with other type car in nontraffic accident"
# Category title: Car driver injured in collision with other type car in nontraffic accident

Abbreviated description: Car driver injured in collision w car nontraf, init

Full description: Car driver injured in collision with other type car in nontraffic accident, initial encounter
