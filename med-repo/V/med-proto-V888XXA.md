V888,XXA,V888XXA,"Person inj in oth nonclsn trnsp acc w mtr veh, nontraf, init", "Person injured in other specified noncollision transport accidents involving motor vehicle, nontraffic, initial encounter","Person injured in other specified noncollision transport accidents involving motor vehicle, nontraffic"
# Category title: Person injured in other specified noncollision transport accidents involving motor vehicle, nontraffic

Abbreviated description: Person inj in oth nonclsn trnsp acc w mtr veh, nontraf, init

Full description: Person injured in other specified noncollision transport accidents involving motor vehicle, nontraffic, initial encounter
