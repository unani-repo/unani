V299,XXA,V299XXA,"Motorcycle rider (driver) injured in unsp traf, init", "Motorcycle rider (driver) (passenger) injured in unspecified traffic accident, initial encounter","Motorcycle rider (driver) (passenger) injured in unspecified traffic accident"
# Category title: Motorcycle rider (driver) (passenger) injured in unspecified traffic accident

Abbreviated description: Motorcycle rider (driver) injured in unsp traf, init

Full description: Motorcycle rider (driver) (passenger) injured in unspecified traffic accident, initial encounter
