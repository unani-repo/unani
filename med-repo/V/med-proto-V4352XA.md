V4352,XA,V4352XA,"Car driver injured in collision w car in traf, init", "Car driver injured in collision with other type car in traffic accident, initial encounter","Car driver injured in collision with other type car in traffic accident"
# Category title: Car driver injured in collision with other type car in traffic accident

Abbreviated description: Car driver injured in collision w car in traf, init

Full description: Car driver injured in collision with other type car in traffic accident, initial encounter
