V878,XXA,V878XXA,"Person injured in oth nonclsn transport acc w mtr veh, init", "Person injured in other specified noncollision transport accidents involving motor vehicle (traffic), initial encounter","Person injured in other specified noncollision transport accidents involving motor vehicle (traffic)"
# Category title: Person injured in other specified noncollision transport accidents involving motor vehicle (traffic)

Abbreviated description: Person injured in oth nonclsn transport acc w mtr veh, init

Full description: Person injured in other specified noncollision transport accidents involving motor vehicle (traffic), initial encounter
