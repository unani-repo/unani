V872,XXD,V872XXD,"Person injured in collision betw car and pk-up/van, subs", "Person injured in collision between car and pick-up truck or van (traffic), subsequent encounter","Person injured in collision between car and pick-up truck or van (traffic)"
# Category title: Person injured in collision between car and pick-up truck or van (traffic)

Abbreviated description: Person injured in collision betw car and pk-up/van, subs

Full description: Person injured in collision between car and pick-up truck or van (traffic), subsequent encounter
