V1988,XA,V1988XA,"Pedl cyclst (driver) injured in oth transport acc, init", "Pedal cyclist (driver) (passenger) injured in other specified transport accidents, initial encounter","Pedal cyclist (driver) (passenger) injured in other specified transport accidents"
# Category title: Pedal cyclist (driver) (passenger) injured in other specified transport accidents

Abbreviated description: Pedl cyclst (driver) injured in oth transport acc, init

Full description: Pedal cyclist (driver) (passenger) injured in other specified transport accidents, initial encounter
