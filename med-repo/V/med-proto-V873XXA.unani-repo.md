V873,XXA,V873XXA,"Person injured in collision betw car and bus (traffic), init", "Person injured in collision between car and bus (traffic), initial encounter","Person injured in collision between car and bus (traffic)"
# Category title: Person injured in collision between car and bus (traffic)

Abbreviated description: Person injured in collision betw car and bus (traffic), init

Full description: Person injured in collision between car and bus (traffic), initial encounter
