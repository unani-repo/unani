V00141,D,V00141D,"Fall from scooter (nonmotorized), subsequent encounter", "Fall from scooter (nonmotorized), subsequent encounter","Fall from scooter (nonmotorized)"
# Category title: Fall from scooter (nonmotorized)

Abbreviated description: Fall from scooter (nonmotorized), subsequent encounter

Full description: Fall from scooter (nonmotorized), subsequent encounter
