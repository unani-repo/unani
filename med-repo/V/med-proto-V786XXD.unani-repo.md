V786,XXD,V786XXD,"Pasngr on bus injured in nonclsn trnsp acc in traf, subs", "Passenger on bus injured in noncollision transport accident in traffic accident, subsequent encounter","Passenger on bus injured in noncollision transport accident in traffic accident"
# Category title: Passenger on bus injured in noncollision transport accident in traffic accident

Abbreviated description: Pasngr on bus injured in nonclsn trnsp acc in traf, subs

Full description: Passenger on bus injured in noncollision transport accident in traffic accident, subsequent encounter
