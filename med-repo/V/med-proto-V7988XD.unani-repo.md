V7988,XD,V7988XD,"Bus occupant (driver) injured in oth transport acc, subs", "Bus occupant (driver) (passenger) injured in other specified transport accidents, subsequent encounter","Bus occupant (driver) (passenger) injured in other specified transport accidents"
# Category title: Bus occupant (driver) (passenger) injured in other specified transport accidents

Abbreviated description: Bus occupant (driver) injured in oth transport acc, subs

Full description: Bus occupant (driver) (passenger) injured in other specified transport accidents, subsequent encounter
