V880,XXD,V880XXD,"Person inj in clsn betw car and 2/3-whl mv, nontraf, subs", "Person injured in collision between car and two- or three-wheeled motor vehicle, nontraffic, subsequent encounter","Person injured in collision between car and two- or three-wheeled motor vehicle, nontraffic"
# Category title: Person injured in collision between car and two- or three-wheeled motor vehicle, nontraffic

Abbreviated description: Person inj in clsn betw car and 2/3-whl mv, nontraf, subs

Full description: Person injured in collision between car and two- or three-wheeled motor vehicle, nontraffic, subsequent encounter
