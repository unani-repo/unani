V875,XXS,V875XXS,"Person injured in collision betw hv veh and bus, sequela", "Person injured in collision between heavy transport vehicle and bus (traffic), sequela","Person injured in collision between heavy transport vehicle and bus (traffic)"
# Category title: Person injured in collision between heavy transport vehicle and bus (traffic)

Abbreviated description: Person injured in collision betw hv veh and bus, sequela

Full description: Person injured in collision between heavy transport vehicle and bus (traffic), sequela
