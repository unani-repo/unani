V9304,XA,V9304XA,"Burn due to localized fire on board sailboat, init encntr", "Burn due to localized fire on board sailboat, initial encounter","Burn due to localized fire on board sailboat"
# Category title: Burn due to localized fire on board sailboat

Abbreviated description: Burn due to localized fire on board sailboat, init encntr

Full description: Burn due to localized fire on board sailboat, initial encounter
