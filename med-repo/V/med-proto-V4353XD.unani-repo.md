V4353,XD,V4353XD,"Car driver injured in clsn w pick-up truck in traf, subs", "Car driver injured in collision with pick-up truck in traffic accident, subsequent encounter","Car driver injured in collision with pick-up truck in traffic accident"
# Category title: Car driver injured in collision with pick-up truck in traffic accident

Abbreviated description: Car driver injured in clsn w pick-up truck in traf, subs

Full description: Car driver injured in collision with pick-up truck in traffic accident, subsequent encounter
