V877,XXA,V877XXA,"Person injured in collision betw oth mtr veh (traffic), init", "Person injured in collision between other specified motor vehicles (traffic), initial encounter","Person injured in collision between other specified motor vehicles (traffic)"
# Category title: Person injured in collision between other specified motor vehicles (traffic)

Abbreviated description: Person injured in collision betw oth mtr veh (traffic), init

Full description: Person injured in collision between other specified motor vehicles (traffic), initial encounter
