V877,XXD,V877XXD,"Person injured in collision betw oth mtr veh (traffic), subs", "Person injured in collision between other specified motor vehicles (traffic), subsequent encounter","Person injured in collision between other specified motor vehicles (traffic)"
# Category title: Person injured in collision between other specified motor vehicles (traffic)

Abbreviated description: Person injured in collision betw oth mtr veh (traffic), subs

Full description: Person injured in collision between other specified motor vehicles (traffic), subsequent encounter
