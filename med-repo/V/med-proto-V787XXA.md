V787,XXA,V787XXA,"Person outside bus inj in nonclsn trnsp acc in traf, init", "Person on outside of bus injured in noncollision transport accident in traffic accident, initial encounter","Person on outside of bus injured in noncollision transport accident in traffic accident"
# Category title: Person on outside of bus injured in noncollision transport accident in traffic accident

Abbreviated description: Person outside bus inj in nonclsn trnsp acc in traf, init

Full description: Person on outside of bus injured in noncollision transport accident in traffic accident, initial encounter
