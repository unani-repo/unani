V4351,XA,V4351XA,"Car driver injured in collision w SUV in traf, init", "Car driver injured in collision with sport utility vehicle in traffic accident, initial encounter","Car driver injured in collision with sport utility vehicle in traffic accident"
# Category title: Car driver injured in collision with sport utility vehicle in traffic accident

Abbreviated description: Car driver injured in collision w SUV in traf, init

Full description: Car driver injured in collision with sport utility vehicle in traffic accident, initial encounter
