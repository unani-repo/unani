V4354,XA,V4354XA,"Car driver injured in collision w van in traf, init", "Car driver injured in collision with van in traffic accident, initial encounter","Car driver injured in collision with van in traffic accident"
# Category title: Car driver injured in collision with van in traffic accident

Abbreviated description: Car driver injured in collision w van in traf, init

Full description: Car driver injured in collision with van in traffic accident, initial encounter
