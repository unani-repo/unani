V787,XXD,V787XXD,"Person outside bus inj in nonclsn trnsp acc in traf, subs", "Person on outside of bus injured in noncollision transport accident in traffic accident, subsequent encounter","Person on outside of bus injured in noncollision transport accident in traffic accident"
# Category title: Person on outside of bus injured in noncollision transport accident in traffic accident

Abbreviated description: Person outside bus inj in nonclsn trnsp acc in traf, subs

Full description: Person on outside of bus injured in noncollision transport accident in traffic accident, subsequent encounter
