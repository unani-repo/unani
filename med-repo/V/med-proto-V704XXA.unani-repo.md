V704,XXA,V704XXA,"Prsn brd/alit from bus injured in collision w ped/anml, init", "Person boarding or alighting from bus injured in collision with pedestrian or animal, initial encounter","Person boarding or alighting from bus injured in collision with pedestrian or animal"
# Category title: Person boarding or alighting from bus injured in collision with pedestrian or animal

Abbreviated description: Prsn brd/alit from bus injured in collision w ped/anml, init

Full description: Person boarding or alighting from bus injured in collision with pedestrian or animal, initial encounter
