V425,XXS,V425XXS,"Car driver injured in clsn w 2/3-whl mv in traf, sequela", "Car driver injured in collision with two- or three-wheeled motor vehicle in traffic accident, sequela","Car driver injured in collision with two- or three-wheeled motor vehicle in traffic accident"
# Category title: Car driver injured in collision with two- or three-wheeled motor vehicle in traffic accident

Abbreviated description: Car driver injured in clsn w 2/3-whl mv in traf, sequela

Full description: Car driver injured in collision with two- or three-wheeled motor vehicle in traffic accident, sequela
