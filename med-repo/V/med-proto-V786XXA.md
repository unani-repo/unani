V786,XXA,V786XXA,"Pasngr on bus injured in nonclsn trnsp acc in traf, init", "Passenger on bus injured in noncollision transport accident in traffic accident, initial encounter","Passenger on bus injured in noncollision transport accident in traffic accident"
# Category title: Passenger on bus injured in noncollision transport accident in traffic accident

Abbreviated description: Pasngr on bus injured in nonclsn trnsp acc in traf, init

Full description: Passenger on bus injured in noncollision transport accident in traffic accident, initial encounter
