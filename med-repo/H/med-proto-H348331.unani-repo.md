H34833,1,H348331,"Trib rtnl vein occlusion, bilateral, w rtnl neovas", "Tributary (branch) retinal vein occlusion, bilateral, with retinal neovascularization","Tributary (branch) retinal vein occlusion, bilateral"
# Category title: Tributary (branch) retinal vein occlusion, bilateral

Abbreviated description: Trib rtnl vein occlusion, bilateral, w rtnl neovas

Full description: Tributary (branch) retinal vein occlusion, bilateral, with retinal neovascularization
