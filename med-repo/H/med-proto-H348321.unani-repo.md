H34832,1,H348321,"Trib rtnl vein occlusion, left eye, w rtnl neovas", "Tributary (branch) retinal vein occlusion, left eye, with retinal neovascularization","Tributary (branch) retinal vein occlusion, left eye"
# Category title: Tributary (branch) retinal vein occlusion, left eye

Abbreviated description: Trib rtnl vein occlusion, left eye, w rtnl neovas

Full description: Tributary (branch) retinal vein occlusion, left eye, with retinal neovascularization
