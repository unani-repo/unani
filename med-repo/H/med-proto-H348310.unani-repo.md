H34831,0,H348310,"Trib rtnl vein occlusion, right eye, with macular edema", "Tributary (branch) retinal vein occlusion, right eye, with macular edema","Tributary (branch) retinal vein occlusion, right eye"
# Category title: Tributary (branch) retinal vein occlusion, right eye

Abbreviated description: Trib rtnl vein occlusion, right eye, with macular edema

Full description: Tributary (branch) retinal vein occlusion, right eye, with macular edema
