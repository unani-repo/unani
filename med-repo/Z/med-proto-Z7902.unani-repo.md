Z790,2,Z7902,"Long term (current) use of antithrombotics/antiplatelets", "Long term (current) use of antithrombotics/antiplatelets","Long term (current) use of anticoagulants and antithrombotics/antiplatelets"
# Category title: Long term (current) use of anticoagulants and antithrombotics/antiplatelets

Abbreviated description: Long term (current) use of antithrombotics/antiplatelets

Full description: Long term (current) use of antithrombotics/antiplatelets
