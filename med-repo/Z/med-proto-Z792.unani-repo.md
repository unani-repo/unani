Z790,Z792,Z792,"Long term (current) use of antibiotics", "Long term (current) use of antibiotics","Long term (current) use of anticoagulants and antithrombotics/antiplatelets"
# Category title: Long term (current) use of anticoagulants and antithrombotics/antiplatelets

Abbreviated description: Long term (current) use of antibiotics

Full description: Long term (current) use of antibiotics
