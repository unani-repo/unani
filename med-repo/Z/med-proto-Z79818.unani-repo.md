Z7981,8,Z79818,"Lng trm (crnt) use of agnt aff estrog recpt & estrog levels", "Long term (current) use of other agents affecting estrogen receptors and estrogen levels","Long term (current) use of agents affecting estrogen receptors and estrogen levels"
# Category title: Long term (current) use of agents affecting estrogen receptors and estrogen levels

Abbreviated description: Lng trm (crnt) use of agnt aff estrog recpt & estrog levels

Full description: Long term (current) use of other agents affecting estrogen receptors and estrogen levels
