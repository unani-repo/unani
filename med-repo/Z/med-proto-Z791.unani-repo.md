Z790,Z791,Z791,"Long term (current) use of non-steroidal non-inflam (NSAID)", "Long term (current) use of non-steroidal anti-inflammatories (NSAID)","Long term (current) use of anticoagulants and antithrombotics/antiplatelets"
# Category title: Long term (current) use of anticoagulants and antithrombotics/antiplatelets

Abbreviated description: Long term (current) use of non-steroidal non-inflam (NSAID)

Full description: Long term (current) use of non-steroidal anti-inflammatories (NSAID)
