Z7981,Z7984,Z7984,"Long term (current) use of oral hypoglycemic drugs", "Long term (current) use of oral hypoglycemic drugs","Long term (current) use of agents affecting estrogen receptors and estrogen levels"
# Category title: Long term (current) use of agents affecting estrogen receptors and estrogen levels

Abbreviated description: Long term (current) use of oral hypoglycemic drugs

Full description: Long term (current) use of oral hypoglycemic drugs
