Z88,1,Z881,"Allergy status to other antibiotic agents status", "Allergy status to other antibiotic agents status","Allergy status to drugs, medicaments and biological substances"
# Category title: Allergy status to drugs, medicaments and biological substances

Abbreviated description: Allergy status to other antibiotic agents status

Full description: Allergy status to other antibiotic agents status
