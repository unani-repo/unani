Z7981,Z7982,Z7982,"Long term (current) use of aspirin", "Long term (current) use of aspirin","Long term (current) use of agents affecting estrogen receptors and estrogen levels"
# Category title: Long term (current) use of agents affecting estrogen receptors and estrogen levels

Abbreviated description: Long term (current) use of aspirin

Full description: Long term (current) use of aspirin
