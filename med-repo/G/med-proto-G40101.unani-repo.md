...
Abbreviated description: Local-rel symptc epi w simp part seiz, not ntrct, w stat epi

Full description: Localization-related (focal) (partial) symptomatic epilepsy and epileptic syndromes with simple partial seizures, not intractable, with status epilepticus
