W1782,XD,W1782XD,"Fall from (out of) grocery cart, subsequent encounter", "Fall from (out of) grocery cart, subsequent encounter","Fall from (out of) grocery cart"
# Category title: Fall from (out of) grocery cart

Abbreviated description: Fall from (out of) grocery cart, subsequent encounter

Full description: Fall from (out of) grocery cart, subsequent encounter
