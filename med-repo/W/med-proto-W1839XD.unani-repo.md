W1839,XD,W1839XD,"Other fall on same level, subsequent encounter", "Other fall on same level, subsequent encounter","Other fall on same level"
# Category title: Other fall on same level

Abbreviated description: Other fall on same level, subsequent encounter

Full description: Other fall on same level, subsequent encounter
