W101,XXD,W101XXD,"Fall (on)(from) sidewalk curb, subsequent encounter", "Fall (on)(from) sidewalk curb, subsequent encounter","Fall (on)(from) sidewalk curb"
# Category title: Fall (on)(from) sidewalk curb

Abbreviated description: Fall (on)(from) sidewalk curb, subsequent encounter

Full description: Fall (on)(from) sidewalk curb, subsequent encounter
