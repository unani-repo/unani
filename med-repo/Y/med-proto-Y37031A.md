Y37031,A,Y37031A,"Milt op w explosn of sea-based artlry shell, civilian, init", "Military operations involving explosion of sea-based artillery shell, civilian, initial encounter","Military operations involving explosion of sea-based artillery shell, civilian"
# Category title: Military operations involving explosion of sea-based artillery shell, civilian

Abbreviated description: Milt op w explosn of sea-based artlry shell, civilian, init

Full description: Military operations involving explosion of sea-based artillery shell, civilian, initial encounter
