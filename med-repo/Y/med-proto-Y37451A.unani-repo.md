Y37451,A,Y37451A,"Milt op w combat using blunt/pierc object, civilian, init", "Military operations involving combat using blunt or piercing object, civilian, initial encounter","Military operations involving combat using blunt or piercing object, civilian"
# Category title: Military operations involving combat using blunt or piercing object, civilian

Abbreviated description: Milt op w combat using blunt/pierc object, civilian, init

Full description: Military operations involving combat using blunt or piercing object, civilian, initial encounter
