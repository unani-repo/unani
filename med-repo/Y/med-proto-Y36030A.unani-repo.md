Y36030,A,Y36030A,"War op w explosn of sea-based artlry shell, milt, init", "War operations involving explosion of sea-based artillery shell, military personnel, initial encounter","War operations involving explosion of sea-based artillery shell, military personnel"
# Category title: War operations involving explosion of sea-based artillery shell, military personnel

Abbreviated description: War op w explosn of sea-based artlry shell, milt, init

Full description: War operations involving explosion of sea-based artillery shell, military personnel, initial encounter
