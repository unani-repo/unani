Y37450,A,Y37450A,"Milt op w combat using blunt/pierc object, milt, init", "Military operations involving combat using blunt or piercing object, military personnel, initial encounter","Military operations involving combat using blunt or piercing object, military personnel"
# Category title: Military operations involving combat using blunt or piercing object, military personnel

Abbreviated description: Milt op w combat using blunt/pierc object, milt, init

Full description: Military operations involving combat using blunt or piercing object, military personnel, initial encounter
