S60421,A,S60421A,"Blister (nonthermal) of left index finger, initial encounter", "Blister (nonthermal) of left index finger, initial encounter","Blister (nonthermal) of left index finger"
# Category title: Blister (nonthermal) of left index finger

Abbreviated description: Blister (nonthermal) of left index finger, initial encounter

Full description: Blister (nonthermal) of left index finger, initial encounter
