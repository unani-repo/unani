S90521,D,S90521D,"Blister (nonthermal), right ankle, subsequent encounter", "Blister (nonthermal), right ankle, subsequent encounter","Blister (nonthermal), right ankle"
# Category title: Blister (nonthermal), right ankle

Abbreviated description: Blister (nonthermal), right ankle, subsequent encounter

Full description: Blister (nonthermal), right ankle, subsequent encounter
